	...
	for(i=0;i<num;i++){
		...
		switch(type) {
			case SP_BONUS_FIREPOWER:
				s=sprite_add_file("bonus_p.png",1,PR_BONUS);
				s->anim_speed=0;
				break;
			case SP_BONUS_ADDSPEED:
				...
				break;
			case SP_BONUS_BOMB:
				s=sprite_add_file("bonus_f.png",1,PR_BONUS);
				s->anim_speed=0;
				break;
			case SP_BONUS_COIN:
				s=sprite_add_file("coin.png",1,PR_BONUS);
				s->anim_speed=0;
				break;
			case SP_BONUS_EXTRA:
			...
			case SP_BONUS_HEALTH:
				...
				s->anim_speed=2;
				break;
			case SP_BONUS_FIREPOWER_G:
				s=sprite_add_file("bonus_p_.png",1,PR_BONUS);		//***090124		追加
				s->anim_speed=0;
				break;
			default:
				CHECKPOINT;
...
void bonus_add(int x, int y, int type)
{
	...
	switch(type) {
	case SP_BONUS_FIREPOWER:
		s=sprite_add_file("bonus_p.png",1,PR_BONUS);		//***090123		変更
		s->anim_speed=0;
		break;
	case SP_BONUS_ADDSPEED:
		s=sprite_add_file("bonus_s.png",16,PR_BONUS);
		...
		break;
	case SP_BONUS_BOMB:
		s=sprite_add_file("bonus_f.png",1,PR_BONUS);		//***090123		変更
		s->anim_speed=0;
		break;
	case SP_BONUS_COIN:
		s=sprite_add_file("coin.png",1,PR_BONUS);		//***090123		変更
		s->anim_speed=0;
		break;
	case SP_BONUS_EXTRA:
		s=sprite_add_file("bonus_x.png",16,PR_BONUS);
