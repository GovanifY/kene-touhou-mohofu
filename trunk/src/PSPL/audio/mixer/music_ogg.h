 ...
 */
extern int OGG_init(PSPL_AUDIO_SPEC *mixer);
...
extern void OGG_playAudio(OGG_music *music, u8 *stream, int len);
...
//extern void OGG_jump_to_time(OGG_music *music, dou ble time);
