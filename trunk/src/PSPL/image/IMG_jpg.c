 ...
 */
//[廃止]static void in it_source(j_decompress_ptr cinfo)	//(jpeg展開前処理用コールバック)
//[廃止]{
//[廃止]	/* We don't actually need to do anything */
//[廃止]	return;
//[廃止]}
 ...
 */
//[廃止]static void te rm_source(j_decompress_ptr cinfo)	//(jpeg展開後処理用コールバック)
//[廃止]{
//[廃止]	/* We don't actually need to do anything */
//[廃止]	return;
//[廃止]}
...
static void jpeg_SDL_RW_src(j_decompress_ptr cinfo, SDL_RWops *ctx)
{
	...
	src 						= (my_source_mgr *) cinfo->src;
//[廃止]	src->pub.in it_source		= in it_source; 	//(jpeg展開前処理用コールバック)
	src->pub.fill_input_buffer	= fill_input_buffer;
	src->pub.skip_input_data	= skip_input_data;
	src->pub.resync_to_restart	= jpeg_resync_to_restart;	/* use default method */
//[廃止]	src->pub.te rm_source		= te rm_source; 	//(jpeg展開後処理用コールバック)
	src->ctx					= ctx;
