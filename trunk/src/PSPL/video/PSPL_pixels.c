...
psp - リビジョン 441Subversion リポジトリ一覧: pspps2ps2wareps3ps3warepspwareリビジョン:(root)/trunk/SDL/src/video/SDL_pixels.c
...
//#include "./../include/PSPL_endian.h" /* 取り敢えず(仮) */
