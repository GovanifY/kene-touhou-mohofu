...
/*global*/static void item_create_15_rumia(SPRITE *src)
{
	...
	item_create_num(src, /*item_type*/(SP_GROUP_ITEMS|(item_tbl[(cg.game_difficulty)])), (7) ); 	/* ちらばる */
}
...
static void zako_shot_supeka(SPRITE *src, u8 zako_supeka_type);/*(宣言)*/
...
static void angle_to_vector(SPRITE *src)/*(角度をX軸、Y軸のベクトル速度へ変換する)*/
{
