...
static void check_colision_gamengai(SPRITE *src)
{
...
/*static*/static/*global*/ void player_register_shot_object(SPRITE *src, int /*set_*/shot_type)
{
	...
	//
		...
		static const u8 base_shot_atari[16] =
...
//		h->flags			|= (SP_FLAG_VISIBLE|SP_FLAG_TIME_OVER);
	...
	//
			/*(r32はそもそも自機が強すぎるのが原因で、ボスをどう作ってもカード前にボスが死ぬ。それでゲームが破綻している。)*/
...
MAX | 18   | 18 |	| × 2.8 |	1300	|| MAX |  30  |  3 |   | × -.- |	 ?
	...
	//		18,18,10,15, 3, 4, 3, 3,	/* speed	針の速さ (遅い方が画面上の弾数が増えるので強い。ただし重くなる) */
		...
		h->base_weapon_strength = ccc_tbl[CCC_STRENGTH_L1+(cg.jiki_weapon_level_offset)+(is_needle<<(4+2))];/* 64 == 8[players]*8[line] */
	//	h->base_weapon_strength = ddd_tbl[DDD_STRENGTH_L1+(cg.jiki_weapon_level_offset)];
			...
			#endif
			{
				...
				//	if ( (REIMU_SHOT_TYPE_00) == shot_type)/* 誘導ショットか？ */
					...
					//	if (511 < int_angle1024 )/* 上方180-360度[/360度]の領域のみ追尾する */
						...
						{
							/*16==ccc_tbl[CCC_SPEED+(cg_game_select_player)]*/
							/*16==ccc_tbl[CCC_SPEED+(cg_game_select_player)]*/
							#if (0)//
...
static void regist_3_way(SPRITE *s)
{
	...
	/* 通常ショット(4wayの場合) */
static void regist_4_way(SPRITE *s)
{
	player_register_shot_object(s, REIMU_SHOT_TYPE_04); 	/* 通常ショット */
	player_register_shot_object(s, REIMU_SHOT_TYPE_02); 	/* 通常ショット */
	player_register_shot_object(s, REIMU_SHOT_TYPE_03); 	/* 通常ショット */
	...
	/* 通常ショット(5wayの場合) */
static void regist_5_way(SPRITE *s)
{
	...
	/* 通常ショット(幽々子の場合) */
static void regist_0_way(SPRITE *s)
{
...
//	if (0==(cg.state_flag & STATE_FLAG_06_IS_KAIWA_MODE))
	if (cg.state_flag & JIKI_FLAG_0x08_SHOT_KEY_SEND_FOR_OPTION)/* off(オプションがショットを撃つ場合) */
	{
...
//(r33)誘導巫女のオプションは弱いと全然やる気がない。
	  ...
	  10,	5,	 7,   4,	8,	19,   7,   8,	 /* WEAPON_L4 */
	   4,	3,	 6,   3,	8,	16,   5,   6,	 /* WEAPON_L5 */
			...
			src->PL_OPTION_DATA_opt_shot_interval = player_bbb_status[(cg.jiki_weapon_level_offset)];/* (霊夢 魔理沙	仮幽々子)オプションのショット間隔 */
			#if 1//
	...
	else
	{
		...
		//	/*cg.*/weapon_interval = jiki_auto_shot_interval_table[(weapon_List<<3)+(cg_game_select_player)];
			...
			static /*const*/ void (*bbb[(WEAPON_L_MAX)*(PLAYERS8)])(SPRITE *sss) =
			{
				...
				regist_1_way,	regist_1_way,	regist_1_way,	regist_1_way,	regist_1_way,	regist_0_way,	regist_2_way,	regist_2_way,	/* WEAPON_L0:(P000-P008) */
				regist_1_way,	regist_1_way,	regist_2_way,	regist_2_way,	regist_1_way,	regist_0_way,	regist_2_way,	regist_2_way,	/* WEAPON_L1:(P008-P015) */
				regist_2_way,	regist_2_way,	regist_2_way,	regist_3_way,	regist_2_way,	regist_0_way,	regist_2_way,	regist_3_way,	/* WEAPON_L2:(P016-P031) */
				regist_3_way,	regist_3_way,	regist_3_way,	regist_4_way,	regist_2_way,	regist_0_way,	regist_3_way,	regist_3_way,	/* WEAPON_L3:(P032-P063) */
				regist_3_way,	regist_4_way,	regist_3_way,	regist_4_way,	regist_2_way,	regist_0_way,	regist_3_way,	regist_3_way,	/* WEAPON_L4:(P064-P127) */
				regist_4_way,	regist_5_way,	regist_3_way,	regist_5_way,	regist_2_way,	regist_0_way,	regist_3_way,	regist_3_way,	/* WEAPON_L5:(P128) 	 */
			};
