...
/*	自分A */
//	S P_PLAYER_ITEM/*プレイヤーの本体(あたり判定がアイテム取得)*/			= /*0x0100*/SP_GROUP_JIKI_GET_ITEM,
/*	自弾 */
//	S P_SHOT_BOSS,/*プレイヤーのボスに有効弾*/							//	= /*0x0200*/SP_GROUP_SHOTS,
...
//	S P_CHUU,// /*特殊敵[中型敵]*/ /*S P_ZA KO_YOKAI1*/ 					= /*0x0400*/SP_GROUP_BOSS,
//	S P_BO SS,
/* ------------- */
/*	敵弾 */
