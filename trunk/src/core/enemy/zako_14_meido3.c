...
static void move_meido3(SPRITE *s)
{
	...
	case 0: 	/* 左周りで回転中 */
		...
		//	data->angle512 = deg_360_to_512(0/*360*/ /*-10*/)/*deg_360_to_512(360)*/;
			data->state=1;
			if (0 < /*data->*/level)	{	bullet_create_n_way_dan_sa_type(s, /*speed256*/t256(2), ANGLE_JIKINERAI_DAN/*angle512*/, (int)(512/24), BULLET_UROKO14_01_AKA, /*n*/(difficulty<<1)); }/* easy以外は狙い弾を打つ */
