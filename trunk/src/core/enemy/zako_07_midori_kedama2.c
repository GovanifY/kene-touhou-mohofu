...
static void move_midori_kedama2(SPRITE *src)
{
	...
	if (0 < data->wait2)
	{
		if (0 == data->wait1)
		{
		//	src->y256 += (t256(3)+t256(/*data->*/level))/*(t256(3)+t256(data->level))*/ /**fps_fa ctor*/;/*はやすぎ*/
			src->y256 += (t256(0.75)+((/*data->*/level)<<6))/*(t256(3)+t256(data->level))*/ /**fps_fa ctor*/;
		...
		{
		//	src->y256 -= (t256(2)+t256(/*data->*/level))/*(t256(2)+t256(data->level/3))*/ /**fps_fa ctor*/;/*はやすぎ*/
			src->y256 -= (t256(0.5)+((/*data->*/level)<<5))/*(t256(2)+t256(data->level/3))*/ /**fps_fa ctor*/;
	...
	//	if (/*0 <*/ /*data->*/level)	/* easyは速いんだから場合分けしない */
		...
		//	if (0==(ra_nd()%(100-/*data->*/level*10)))
			...
			{
				bullet_create_aka_maru_jikinerai(src,  t256(2.5)+(/*data->*/level<<6) );/*高速弾*/	//t256(3)+((/*data->*/level<<7))
			}
		}
	}
	else
...
//
	...
	for (i=0; i<NUM_OF_ENEMIES; i++)
	{
		...
		s->data 				= data;
		/*data->base.*/s->base_score		= score(10*2)*(1+lv);
		/*data->base.*/s->base_health		= ((2*8)+(lv<<2)+(difficulty<<2));/* (1+lv+(difficulty<<2)) よわすぎ*/
		data->wait1 			= 0;
		data->wait2 			= 5;/*2*/
	}
}
