...
//			src->an im_frame++;
//			if (src->an im_frame > (src->yx_frames&YX_FRAME_LOW_X) )
//			{
//				src->type = SP_DELETE;
//			}
//		}
...
/*static*/ void bakuhatsu_add_zako04(SPRITE *src)
{
	...
	#else
	send1_obj->x256 = src->x256+((s->w128));
	send1_obj->y256 = src->y256+((s->h128));/*+t256(5)*/
	#endif
	bakuhatsu_add_type_ddd(send1_obj/*s->x256,s->y256+t256(5)*/,/*0,*/BAKUHATSU_ZAKO04/*BAKUHATSU_MINI00*/);/*ザコ消滅爆発*/
//	bakuhatsu_add_type_ddd(send1_obj/*s->x256+((s->w128)),s->y256+((s->h128))*/,/*0,*/BAKUHATSU_ZAKO04/*BAKUHATSU_FIRE08*/);
