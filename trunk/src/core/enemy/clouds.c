...
static void clouds_mover(SPRITE *src)
{
	...
	src->y256 += data->speed_base256/**fps_fa ctor*/;
	src->y256 += data->speed_rand256/**fps_fa ctor*/;
...
//	Uint8 priority, 		PR IORITY_00_BG/*P R_BACK0*/,
//	int use_alpha,			0,
//	int anime_speed 		3
	...
	{
		{
			...
			1/*(l->user_x)*/,
			iyx(1,1),
			PRIORITY_01_SHOT/*PR IORITY_00_BG*/ /*P R_BACK0*/,
			0, 0, 0
		}
	};
