...
static void move_inyou1(SPRITE *src)
{
	...
	case 1:
		...
		{
			data->angle512 += 12; /*rad2 deg512(0.3)*/ /*24*/ /**fps_fa ctor*/ /* rad2 deg512( 0.3)== 24.4461992589151487740904245119933 */
			if (data->angle512 > (256+224)) /*(512)*/
			{
	...
	//	src->x256 = data->destx256 + ((sin512((data->angle512)))<<4);
	//	src->y256 = data->limit_y256 + (cos512((data->angle512))*((32-((data->kaiten_kaisu)))));/*(1+6-data->kaiten_kaisu)*/
	//	+ (cos512((data->angle512))*((32-((data->kaiten_kaisu)))));/*(1+6-data->kaiten_kaisu)*/
		src->vy256 += t256(1);
		src->y256 += src->vy256;
		if (src->y256 >= data->limit_y256)
		{
		...
		if (
		//	(data->angle512 > -57/*rad2 deg512(-0.7)*/ ) &&	/* rad2 deg512(-0.7)==-57.0411316041353471395443238613177 */
		//	(data->angle512 <	32/*rad2 deg512( 0.4)*/ ) &&	/* rad2 deg512( 0.4)== 32.5949323452201983654538993493244 */
