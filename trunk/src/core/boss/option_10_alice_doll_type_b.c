...
//	br.BULLET_REGIST_00_speed256				= (t256(2.0));						/* 弾速 */
	...
	br.BULLET_REGIST_02_angle65536				= ((src->tmp_angleCCW1024)<<6); 		/* 角度 */
	br.BULLET_REGIST_03_tama_data				= (TAMA_DATA_0000_TILT);/* (r33-)標準弾 */
	br.BULLET_REGIST_04_bullet_obj_type 		= BULLET_UROKO14_00_SIRO+1/*+(difficulty)*/;		/* [赤鱗弾] */
