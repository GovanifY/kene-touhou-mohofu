...
{
	＃２．	BG 画面 				非使用					--- 		TEX_00_BACK_GROUND		(原作が2枚なので、将来的に2枚にしたい。道中背景、道中エフェクト、ボススペカ背景、ボススペカエフェクトに使用する)
	...
	＃９．	ITEM面					SP_GROUP_ITEMS			弾幕444 	TEX_06_BULLET
	＃10．	敵弾面					SP_GROUP_BULLETS		弾幕444 	TEX_06_BULLET
}
