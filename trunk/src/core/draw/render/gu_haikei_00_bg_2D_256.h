...
2D背景を描く幅[dots] == 352[dots] == 480[dots]-128[dots] == (psp横)[dots]-(パネル横)[dots]
11 [分割] == 352[dots] / 32[slice]
...
+---+---+-	  -+---+
	...
	-------------------------------------------------------
	テクスチャ縦が256[dots]なので、 1:1分割の場合、縦256までしか描けない。
	(無理やり描くと2D変形されてしまうので描けない。)
	pspの縦は272[dots]なので、256[dots]では足りない。そこで 2回に分けて描く。
	272[dots] == 256[dots] + 16[dots]
	-------------------------------------------------------
	...
	-------------------------------------------------------
