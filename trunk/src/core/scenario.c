...
//	strcpy(fn, data_dir);	strcat(fn, "/scenario/");
	...
	if (	(alpha==-1) /* スクリプト中で省略した場合(デフォルト) */
		|| (alpha==0)	/* 明示した場合 */
	)
	{
		/* アルファ使わない */
