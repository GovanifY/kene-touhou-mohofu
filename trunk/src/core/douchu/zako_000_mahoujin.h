...
static void attack_kougeki_mahoujin02(SPRITE *src)
{
	if (0 < src->MAHOU_TEKI_wait2)
	{
		...
		if (src->MAHOU_TEKI_wait1 <= 0) 	/* ばらまき間隔カウンタ */
		{
			...
			br.BULLET_REGIST_00_speed256							= ((ra_nd()&(512-1))+256);		/* 弾速 */	/*t256(sp)*/
			...
			br.BULLET_REGIST_07_VECTOR_tomari_dan_delta256			= t256(0.04);					/* 減速定数 */
			bullet_regist_vector();
		}
	}
}
...
static void attack_kougeki_mahoujin03(SPRITE *src)
{
	...
	}
	{
		...
		if (src->MAHOU_TEKI_wait1 <= 0) 	/* ばらまき間隔カウンタ */
		{
			...
			br.BULLET_REGIST_00_speed256							= ((ra_nd()&(1024-1))|(0x100)); 	/* 弾速 */	/*t256(sp)*/
			br.BULLET_REGIST_02_VECTOR_angle1024					= ((ra_nd()&(1024-1))); 			/* 角度 */
			br.BULLET_REGIST_05_regist_type 						= REGIST_TYPE_03_TOMARI;
			br.BULLET_REGIST_06_VECTOR_tomari_dan_next_angle1024	= ANGLE_NO_SHOT_DAN;
			br.BULLET_REGIST_07_VECTOR_tomari_dan_delta256			= t256(0.03);	/* 減速定数 */
			bullet_regist_vector();
		}
	}
}
