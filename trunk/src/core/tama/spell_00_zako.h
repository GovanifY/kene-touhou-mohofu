...
static void spell_create_09_zako_sentakki(SPRITE *src)
{
	...
	//
		#if 0
			br.BULLET_REGIST_03_VECTOR_regist_type		= REGIST_TYPE_00_MULTI_VECTOR;
			br.BULLET_REGIST_06_n_way					= (8);									/* [8way] */
			br.BULLET_REGIST_07_VECTOR_div_angle1024	= (int)(1024/24);						/* •ªŠ„Šp“x */
	//
			br.BULLET_REGIST_00_speed256				= (t256(2.0)+((src->boss_spell_timer)<<2)); /* ’e‘¬ */
		{
	...
	//
			br.BULLET_REGIST_00_speed256				= (t256(1.0)+((src->boss_spell_timer)<<2)); /* ’e‘¬ */
		{
