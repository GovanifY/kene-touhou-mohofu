...
"No.12 竹取飛翔 ～ Lunatic Princess\\n" 			"蓬莱山 輝夜のテーマです。\\n"				"月人にならわかるかも。",
"No.13 風神少女 ～ Full Version\\n" 				"射命丸 文のテーマです。\\n"				"1ループ5分以上あるので、長いです。",
"No.14 ラクトガール ～ 少女密室\\n" 				"パチュリー・ノーレッジのテーマです。\\n"	"幺樂風です。",
"No.15 月時計 ～ ルナ・ダイアル\\n" 				"十\六夜 咲夜のテーマです。\\n" 			"ラストなのでこれくらいは必要かと。",
"No.16 おてんば恋娘\\n" 							"チルノのテーマです。\\n"					"この曲は演歌なんですよね、一応。",
  ...
  void music_game_draw_message(int cursor1)
{
	...
	//	"feeddccbbaa99887766554433221100",'\0' ワーク文字列バッファ長をこれだけしか用意しない予定なので、あふれたら字が出ない。 */
		...
		"♪人形裁判　～ 人の形弄びし少女", // No.10 "アリスのテーマです。"
		" 　　　　　 ♪Complete Darkness", // No.11 "魅魔のテーマです。"
		"♪竹取飛翔　～ Lunatic Princess", // No.12 "蓬莱山 輝夜のテーマです。"
		" 　 ♪風神少女　～ Full Version", // No.13 "射命丸 文のテーマです。"
		" 　 ♪ラクトガール　～ 少女密室", // No.14 "パチュリー・ノーレッジのテーマです。"
		" 　 ♪月時計　～ ルナ・ダイアル", // No.15 "十\六夜 咲夜のテーマです。"
		" 　　　　　　　　♪おてんば恋娘", // No.16 "チルノのテーマです。"
		" 　　　　　 ♪Grimoire of Alice", // No.17 "アリスのテーマです。",
		" 　　　　♪恋色マスタースパーク", // No.18 "魔理沙のテーマです。",
		" 　　　　　♪プレイヤーズスコア", // No.19 "エンディングのテーマです。"
		" ♪無何有の郷　～ Deep Mountain", // No.20 "キーコンフィグのテーマです。"
		" 　　　　　　　♪紅より儚い永遠", // No.21 "タイトル画面のテーマです。"
	};
...
/*static*/ void music_room_work(void)
{
	...
	static SDL_Surface *music_room_name_surface[MAX_KEY_NAMES_21];	// 文字の画像 */
