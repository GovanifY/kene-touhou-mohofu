...
/*METHODDEF*/static int consume_markers JPP((j_decompress_ptr cinfo));
...
/* Called once, when first SOS marker is reached */
{
	   ...
	   ci++, compptr++)
	{
		...
		cinfo->max_h_samp_factor = psp_max(cinfo->max_h_samp_factor, compptr->h_samp_factor);
		cinfo->max_v_samp_factor = psp_max(cinfo->max_v_samp_factor, compptr->v_samp_factor);
	}
...
/*LOCAL*/static void per_scan_setup (j_decompress_ptr cinfo)
