 ...
 */
/*模倣風で使用していない*/ //extern int /*SD LCALL*/ Mix_AllocateChannels(int numchans);

/* Find out what the actual audio device parameters are.
   This function returns 1 if the audio has been opened, 0 otherwise.
 */
/*模倣風で使用していない*/ //extern int /*SD LCALL*/ Mix_QuerySpec(int *frequency, u16 *format, int *channels);
...
/*模倣風で使用していない*/ //extern Mix_Chunk * /*SD LCALL*/ Mix_QuickLoad_WAV(u8 *mem);

/* Load raw audio data of the mixer format from a memory buffer */
/*模倣風で使用していない*/ //extern Mix_Chunk * /*SD LCALL*/ Mix_QuickLoad_RAW(u8 *mem, u32 len);
 ...
 */
/*[廃止]フックしない*/ //extern void /*SD LCALL*/ Mix_HookMusic(void (*mix_func) (void *udata, u8 *stream, int len), void *arg);

/* Add your own callback when the music has finished playing.
   This callback is only called if the music finishes naturally.
 */
/*[廃止]フックしない*/ //extern void /*SD LCALL*/ Mix_HookMusicFinished(void (*music_finished)(void));

/* Get a pointer to the user data for the current music hook */
/*[廃止]フックしない*/ //extern void * /*SD LCALL*/ Mix_GetMusicHookData(void);
 ...
 */
/*模倣風で使用していない*/ //extern void /*SD LCALL*/ Mix_ChannelFinished(void (*channel_finished)(int channel));
 ...
 */
/*模倣風で使用していない*/ //extern int /*SD LCALL*/ Mix_ReserveChannels(int num);
...
/*模倣風で使用していない*/ //extern int /*SD LCALL*/ Mix_FadeInChannelTimed(int channel, Mix_Chunk *chunk, int loops, int ms, int ticks);
/*模倣風で使用していない*/ //#define Mix_FadeInChannel(channel,chunk,loops,ms) Mix_FadeInChannelTimed(channel,chunk,loops,ms,-1)
...
/*模倣風で使用していない*/ //extern int /*SD LCALL*/ Mix_VolumeChunk(Mix_Chunk *chunk, int volume);
...
/*模倣風で使用していない*/ //extern int /*SD LCALL*/ Mix_HaltGroup(int tag);
...
*/
/*模倣風で使用していない*/ //extern int /*SD LCALL*/ Mix_ExpireChannel(int channel, int ticks);

/* Halt a channel, fading it out progressively till it's silent
   The ms parameter indicates the number of milliseconds the fading
   will take.
 */
/*模倣風で使用していない*/ //extern int /*SD LCALL*/ Mix_FadeOutChannel(int which, int ms);
/*模倣風で使用していない*/ //extern int /*SD LCALL*/ Mix_FadeOutGroup(int tag, int ms);
extern int /*SD LCALL*/ Mix_FadeOutMusic(int ms);

/* Query the fading status of a channel */
extern Mix_Fading /*SD LCALL*/ Mix_FadingMusic(void);
/*模倣風で使用していない*/ //extern Mix_Fading /*SD LCALL*/ Mix_FadingChannel(int which);
