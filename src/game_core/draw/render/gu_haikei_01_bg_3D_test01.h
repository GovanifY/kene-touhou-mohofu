...
static ScePspFMatrix4 m4_projection3d;
static ScePspFMatrix4 m4_view;
static ScePspFMatrix4 m4_model;

#if (1==TEST_AUTO_ROT)
static ScePspQuatMatrix p9_qcam;
static ScePspQuatMatrix p9_qa;
static ScePspQuatMatrix p9_qb;
#endif
static ScePspQuatMatrix p9_test;
