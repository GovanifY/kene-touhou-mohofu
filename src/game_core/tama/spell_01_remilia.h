...
local void tamaoki_danmaku_01_callback(SPRITE *src)/* 珠置き */
{
	/*(225==1+224==1+7*32)*/
...
/*---------------------------------------------------------
	...
	-------------------------------------------------------
---------------------------------------------------------*/
local void tahane_danmaku_02_callback(SPRITE *src)/* 珠跳ね */
{
...
//	card.danmaku_callback[0] = danmaku_00_standard_angle_mover;/*(通常弾用)*/
	card.danmaku_callback[1] = tamaoki_danmaku_01_callback;/*(珠置き用)*/
	card.danmaku_callback[2] = tahane_danmaku_02_callback;/*(珠跳ね用)*/
