...
global void play_music_num(int next_play_num)
{
	...
	char name[64/*72*/];
	{
		...
		#if (1)
		/*	0 ----- BGM 演奏停止コマンド */
		/*	1 */	"th12_02",		//	"stage1",	/* 1面道中 */
		/*	2 */	"th05_06",		//	"stage2",	/* 2面道中 */
		/*	3 */	"th08_13",		//	"stage3",	/* 3面道中 */
		/*	4 */	"th10_08",		//	"stage4",	/* 4面道中 */
		/*	5 */	"th06_08",		//	"stage5",	/* 5面道中 */
		/*	6 */	"th06_10",		//	"stage6",	/* 6面道中 */
		/*	7 */	"th00_01",		//	"stage7",	/* エンディング(道中) */
		/*	8 */	"th06_04",		//	"stage8",	/* エキストラステージ道中 */
		/*	9 */	"th07_04",		//	"stage9",	/* ファンタズムステージ道中 */
		/* 10 */	"th06_06",		//	"menu4",	/* 上海紅茶館 */
		/* 11 */	"th07_07",		//	"boss1",	/* 1面ボス (アリス) */
		/* 12 */	"th02_11",		//	"boss2",	/* 2面ボス (魅魔) */
		/* 13 */	"th08_15",		//	"boss3",	/* 3面ボス (輝夜) */
		/* 14 */	"th00_11",		//	"boss4",	/* 4面ボス (文) */
		/* 15 */	"th06_09",		//	"boss5",	/* 5面ボス (パチェ) */
		/* 16 */	"th06_11",		//	"boss6",	/* 6面ボス (咲夜) */
		/* 17 */	"th06_05",		//	"boss7",	/* チルノ エキストラステージ1ボス */
		/* 18 */	"th05_17",		//	"boss8",	/* アリス エキストラステージ2ボス */
		/* 19 */	"th08_10",		//	"boss9",	/* 魔理沙 エキストラステージ3ボス */
		/* 20 */	"th07_11",		//	"boss10",	/* 妖夢 隠しボス */
		/* 21 */	"th06_13",		//	"boss11",	/* レミリア 隠しボス */
		/* 22 */	"th06_15",		//	"boss0",	/* フラン 隠しボス */
		/* 23 */	"th04_10",		//	"boss12",	/* 博麗 霊夢 隠しボス */
		/* 24 */	"th06_03",		//	"boss13",	/* ルーミア 隠しボス */
		/* 25 */	"th10_18",		//	"menu3",	/* エンディング(シナリオ) */
		/* 26 */	"th07_02",		//	"menu2",	/* キーコンフィグ */
		/* 27 */	"th07_01",		//	"menu1",	/* タイトル画面 */
		/* 28 */	"th04_07",		//	"stage10",	/* 道中曲です。 */
		/* 29 */	"th08_08",		//	"stage11",	/* 道中曲です。 */
		/* 30 */	"th13_02",		//	"stage12",	/* 道中曲です。 */
		/* 30 */	"th06_16",		//	"menu1",	/* 旧タイトル画面 */
		/* 30 */	"th07_15",		//	"stage13",	/* 道中曲です。妖々跋扈 */
		/* 30 */	"th07_06",		//	"stage14",	/* 道中曲です。ブクレシュティの人形師 */
		#else
		/*	0 ----- BGM 演奏停止コマンド */
		/*[神]*/
		/* 30 */	"th13_02",		//	"stage12",	/* 道中曲です。 */
		...
		/* 29 */	"th08_08",		//	"stage11",	/* 道中曲です。 */
		/*[妖]*/
		/* 20 */	"th07_15",		//	"stage13",	/* 道中曲です。 */
		/* 20 */	"th07_11",		//	"boss10",	/* 妖夢 隠しボス */
		/* 11 */	"th07_07",		//	"boss1",	/* 1面ボス (アリス) */
		/*	9 */	"th07_04",		//	"stage9",	/* ファンタズムステージ道中 */
		/* 26 */	"th07_02",		//	"menu2",	/* キーコンフィグ */
		/* 20 */	"th07_01",		//	"menu1",	/* タイトル画面 */
		/*[紅]*/
		/* 27 */	"th06_16",		//	"menu1",	/* タイトル画面 */
		/* 22 */	"th06_15",		//	"boss0",	/* フラン 隠しボス */
		/* 21 */	"th06_13",		//	"boss11",	/* レミリア 隠しボス */
		/* 16 */	"th06_11",		//	"boss6",	/* 6面ボス (咲夜) */
		/*	6 */	"th06_10",		//	"stage6",	/* 6面道中 */
