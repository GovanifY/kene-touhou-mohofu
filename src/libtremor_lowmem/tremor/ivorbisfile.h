...
typedef struct
{
//	void/*size_t*/	(*read_func_ void)	(void *ptr, size_t size, size_t nmemb, void *datasource);
...
extern long ov_read(OggVorbis_File *vf, void *buffer, int length, int *bitstream);
