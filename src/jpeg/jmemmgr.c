...
print_mem_stats (j_common_ptr cinfo, int pool_id)
{
	 ...
	 */
	error(0/*ERR_FATAL*/, "Freeing pool %d, total space = %ld\n",
...
/*METHODDEF*/ static void *alloc_small (j_common_ptr cinfo, int pool_id, size_t sizeofobject)
/* Allocate a "small" object */
{
	my_mem_ptr mem = (my_mem_ptr) cinfo->mem;
	small_pool_ptr hdr_ptr, prev_hdr_ptr;
	char * data_ptr;
	size_t odd_bytes, min_request;
...
/*METHODDEF*/ static void FAR *alloc_large (j_common_ptr cinfo, int pool_id, size_t sizeofobject)
...
/*METHODDEF*/ static JSAMPARRAY alloc_sarray (j_common_ptr cinfo, int pool_id,
...
/* Allocate a 2-D sample array */
{
  ...
  result = (JSAMPARRAY) alloc_small(cinfo, pool_id,
	...
	{
		rowsperchunk = psp_min(rowsperchunk, numrows - currow);
...
/*METHODDEF*/ static JBLOCKARRAY alloc_barray (j_common_ptr cinfo, int pool_id,
...
/*METHODDEF*/ static jvirt_sarray_ptr request_virt_sarray (j_common_ptr cinfo, int pool_id, boolean pre_zero,
					 JDIMENSION samplesperrow, JDIMENSION numrows,
...
/*METHODDEF*/ static jvirt_barray_ptr request_virt_barray (j_common_ptr cinfo, int pool_id, boolean pre_zero,
					 JDIMENSION blocksperrow, JDIMENSION numrows,
					 JDIMENSION maxaccess)
...
/*METHODDEF*/ static JSAMPARRAY access_virt_sarray(
...
/*METHODDEF*/static JBLOCKARRAY access_virt_barray (j_common_ptr cinfo, jvirt_barray_ptr ptr,
					JDIMENSION start_row, JDIMENSION num_rows,
					boolean writable)
