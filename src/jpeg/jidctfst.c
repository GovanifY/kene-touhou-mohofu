...
/* Multiply a DCTELEM variable by an s32 constant, and immediately
 ...
 * declared s32, so a 32-bit multiply will be used.
 */
 ...
 * We assume that int right shift is unsigned if s32 right shift is.
 */
