...
#include <SDL/SDL_types.h>//#include "SD L_types.h"
#include "MPEGerror.h"
#include "MPEGvideo.h"
#include "MPEGaudio.h"
#include "MPEGlist.h"
...
{
public:
	MPEGstream(class MPEGsystem * System, u8 Streamid);
	~MPEGstream();
	...
	u32 copy_data(u8 *area, s32 size, bool short_read = false);
	...
	void insert_packet(u8 * data, u32 size, /*dou ble*/float timestamp=-1);
