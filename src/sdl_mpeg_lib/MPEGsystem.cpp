...
u8 const PACKET_CODE[]		= { 0x00, 0x00, 0x01, 0xba };
u8 const PACKET_MASK[]		= { 0xff, 0xff, 0xff, 0xff };
u8 const END_CODE[]			= { 0x00, 0x00, 0x01, 0xb9 };
u8 const END_MASK[]			= { 0xff, 0xff, 0xff, 0xff };
u8 const END2_CODE[] 		= { 0x00, 0x00, 0x01, 0xb7 };
u8 const END2_MASK[] 		= { 0xff, 0xff, 0xff, 0xff };
u8 const VIDEOSTREAM_CODE[]	= { 0x00, 0x00, 0x01, 0xe0 };
u8 const VIDEOSTREAM_MASK[]	= { 0xff, 0xff, 0xff, 0xe0 };
u8 const AUDIOSTREAM_CODE[]	= { 0x00, 0x00, 0x01, 0xc0 };
u8 const AUDIOSTREAM_MASK[]	= { 0xff, 0xff, 0xff, 0xc0 };
u8 const PADSTREAM_CODE[]	= { 0x00, 0x00, 0x01, 0xbe };
u8 const PADSTREAM_MASK[]	= { 0xff, 0xff, 0xff, 0xff };
u8 const SYSTEMSTREAM_CODE[] = { 0x00, 0x00, 0x01, 0xbb };
u8 const SYSTEMSTREAM_MASK[] = { 0xff, 0xff, 0xff, 0xff };
u8 const USERSTREAM_CODE[]	= { 0x00, 0x00, 0x01, 0xb2 };
u8 const USERSTREAM_MASK[]	= { 0xff, 0xff, 0xff, 0xff };
u8 const VIDEO_CODE[]		= { 0x00, 0x00, 0x01, 0xb3 };
u8 const VIDEO_MASK[]		= { 0xff, 0xff, 0xff, 0xff };
u8 const AUDIO_CODE[]		= { 0xff, 0xf0, 0x00, 0x00 };
u8 const AUDIO_MASK[]		= { 0xff, 0xf0, 0x00, 0x00 };
u8 const GOP_CODE[]			= { 0x00, 0x00, 0x01, 0xb8 };
u8 const GOP_MASK[]			= { 0xff, 0xff, 0xff, 0xff };
u8 const PICTURE_CODE[]		= { 0x00, 0x00, 0x01, 0x00 };
u8 const PICTURE_MASK[]		= { 0xff, 0xff, 0xff, 0xff };
u8 const SLICE_CODE[]		= { 0x00, 0x00, 0x01, 0x01 };
u8 const SLICE_MASK[]		= { 0xff, 0xff, 0xff, 0x00 };
u8 const ZERO_CODE[] 		= { 0x00, 0x00, 0x00, 0x00 };
u8 const FULL_MASK[] 		= { 0xff, 0xff, 0xff, 0xff };
